#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/the-guong/Proxmox/main/misc/build.func)
...
function update_script() {
  ...
  if check_for_gh_release "tunarr" "chrisbenincasa/tunarr"; then
    ...
    CLEAN_INSTALL=1 fetch_and_deploy_gh_release "tunarr" "chrisbenincasa/tunarr" "singlefile" "latest" "/opt/tunarr" "*linux-arm64"
