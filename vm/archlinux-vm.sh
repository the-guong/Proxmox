...
source /dev/stdin <<<$(curl -fsSL https://raw.githubusercontent.com/the-guong/Proxmox/main/misc/api.func)
...
function arch_check() {
  if [ "$(dpkg --print-architecture)" != "amd64" ]; then
    ...
    echo -e "\n ${YWB}Visit https://github.com/the-guong/Proxmox for ARM64 support. \n"
    echo -e "Exiting..."
    sleep 2
    exit
  fi
